...
class Trainer(object):
    ...
    def load_checkpoint(
        ...
        rank = 0 will loader the checkpoint, and then broadcast it to all
        other ranks.
        """
        extra_state, self._optim_history, last_optim_state = None, [], None

        logger.info(f"Preparing to loader checkpoint {filename}")
        ...
        if bexists:
            ...
            try:
                ...
                raise Exception(
                    "Cannot loader model parameters from checkpoint {}; "
            ...
            if (
                ...
                logger.info(
                    f"Cannot find EMA state in checkpoint, loader model weight to ema directly"
                )
                self.ema = ExponentialMovingAverageModel(
