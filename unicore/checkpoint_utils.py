    ...
    *passthrough_args* will be passed through to
    ...
    if (
        ...
        if args.finetune_from_model is not None and first_launch:
            # if there is no last checkpoint to restore, start the finetune from backbone model
            # else just use usual logic to loader checkpoint, e.g. restart from last checkpoint and etc.
